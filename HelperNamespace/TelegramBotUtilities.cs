	...
	public static class TelegramBotUtilities
	{
		...
		public static async Task<string?> ReturnBaseProfileText(Update update, AppDbContext db)
		{
			...
			string text = $"Имя пользователя: {update.Message.From.Username}\n" +
						...
						$"" +
						$"!!! Предупреждение: если у вас нет юзернейма, вы не будете отображаться другим пользователям. Если вы изменили юзернейм, зайдите и проверьте его здесь — обновился ли он. В противном случае при взаимном лайке ваш юзернейм будет отображаться некорректно !!! \n" +
						$"Ваш юзер видно только после взаимного лайка.";
			return text;
		}
		...
		{
			string text = "⚠️ Убедительная просьба вводить данные корректно. Группы указывайте строго в формате 1ВТН1, 2ТН1 — точно так же, как в расписании. Пожалуйста, внимательно вводите номер телефона. При некорректно указанном номере телефона заявка будет отклонена. В случае ошибок обращайтесь к администратору — мы обновим вашу заявку, но лучше сразу вводить данные правильно. Спасибо за внимание 🙏⚠️ \n" +
				"Участникам из IHL регистрация не обязательно, только в случае если вы хотите стать Queen/King Winter ball 2025🎆";
